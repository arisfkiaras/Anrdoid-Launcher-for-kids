    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finish();
                overridePendingTransition(R.anim.zoom_out_left, R.anim.zoom_out_left);
            }
        });
        buttons.add(button);
        ...
        for (int i = 0; i < apps.size(); i++) {
            ...
            if ((app.active) && (app.category == 1) && (positionsTaken < maxPositions)) {
                addTool(app.name, app.path, positionsTaken);
                positionsTaken++;
            }
        }
    }

    private void addTool(String name, String path, int pos) {
        RelativeLayout table = null;
        switch (pos) {
            case 0:
                table = (RelativeLayout) findViewById(R.id.tool_2);
                break;
            case 1:
                table = (RelativeLayout) findViewById(R.id.tool_3);
                break;
            case 2:
                table = (RelativeLayout) findViewById(R.id.tool_1);
                break;
            case 3:
                table = (RelativeLayout) findViewById(R.id.tool_4);
                break;
        }
